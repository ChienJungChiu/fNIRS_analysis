...
%% load settings file
laser_wavelength='TILS-810nm'; %1064nm , 810nm TILS
...
%     end
    assert(size(rawdata.CST.baseline,3) == Settings.CST.baseline, 'The setting baseline does not match the experiment data baseline!!!')
